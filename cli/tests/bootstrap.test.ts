...
vi.mock("@clawdbot/clawdlets-core/lib/github", () => ({
...
vi.mock("@clawdbot/clawdlets-core/lib/path-expand", () => ({
...
vi.mock("@clawdbot/clawdlets-core/lib/fleet-nix-eval", () => ({
  evalFleetConfig: evalFleetConfigMock,
}));

vi.mock("@clawdbot/clawdlets-core/lib/nix-flakes", () => ({
