...
export function OpenClawSetupStepSecrets(props: {
  projectSlug: string
  ...
  return (
    <div className="space-y-4">
      <HostSecretsPanel projectId={props.projectId} host={props.host} scope="openclaw" />
      ...
      {!props.isComplete ? (
        <div className="text-xs text-muted-foreground">
          Run Secrets Verify for openclaw scope and resolve missing entries.
        </div>
      ) : null}
    </div>
  )
