...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Panel
      ...
      className="text-sm overflow-hidden h-(--accordion-panel-height) data-starting-style:h-0 data-ending-style:h-0 transition-[height] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)]"
      {...props}
    >
      <div
        className={cn(
