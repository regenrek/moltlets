    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({
          ...
          if (orientation === "left") {
            return (
              <HugeiconsIcon icon={ArrowLeftIcon} strokeWidth={strokeWidth} className={cn("size-4", className)} {...props} />
            )
          }

          if (orientation === "right") {
            return (
              <HugeiconsIcon icon={ArrowRightIcon} strokeWidth={strokeWidth} className={cn("size-4", className)} {...props} />
            )
          }

          return (
            <HugeiconsIcon icon={ArrowDownIcon} strokeWidth={strokeWidth} className={cn("size-4", className)} {...props} />
          )
        },
