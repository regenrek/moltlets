...
function GatewaySettingsRoute() {
  ...
  const hostsQueryOptions = convexQuery(api.hosts.listByProject, { projectId: projectId as Id<"projects"> })
  ...
  const gatewaysQueryOptions = convexQuery(api.gateways.listByProjectHost, {
