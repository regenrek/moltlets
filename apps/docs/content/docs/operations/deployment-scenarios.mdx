...
Clawlets lets you split control plane and execution. The right topology depends on your
trust boundary, uptime needs, and operator model.
...
- You want dashboard-driven secret updates through sealed runner input.
...
- Runner must stay on current version with sealed-input capability.
...
1. Start with **VPS dashboard + local runner** for fast adoption and clear control-plane/runner split.
