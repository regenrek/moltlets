...
description: nix-clawdbot updates.
---

`nix-clawdbot` is pinned in the **project repo** (from `clawlets-template`), not this
CLI repo. That pin is the source of truth for the runtime Clawdbot version.
