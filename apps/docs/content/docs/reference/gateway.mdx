...
Clawlets stores the preferred architecture at `fleet.gatewayArchitecture`:
...
`fleet.gatewayArchitecture` is a Clawlets UI preference. It does not get forwarded into OpenClaw.
